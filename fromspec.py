...
def getObjBandContiABmag(obj,band='r'):
	...
	fnu=(filterwavelengths[band]**2/const.c*fl).to(u_fnu)
...
def getObjBandContiRatio_dEdnu(obj, band1='r', band2='z'):
	...
	ratio12_dEdnu=(filterwavelengths[band1]/filterwavelengths[band2])**2 * ratio12_dEdl
...
def getObjBandContiFluxDensity_dEdl(obj, band='r',wunit=False):
	...
	# get filter function
	specfilter, lcoordfilter=getFilterResponseFunc(band=band)
...
def getFilterResponseFunc(band='r'):
	...
	filename='/Users/aisun/Documents/Astro/Thesis/bbselection/SDSS/algorithm/display/sdssdisp/filter_curves.fits'
...
def plotSpecwFilters(obj):
	...
	plt.clf()
	plt.plot(None,None,ls='',color='black',label='z='+'%.3f'%obj.sdss.z)
