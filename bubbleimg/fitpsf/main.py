...
def dir_fit_psf(dir_obj, band='r', fileimg='stamp-lOIII5008_I_norm.fits', searchradius=5., fixb=True, update=False):
    """
    ...
    if (not (os.path.isfile(filemodel) and os.path.isfile(filemodel))) or update:
        # read in
        ...
        print "skip dir_fit_psf as file exists"
